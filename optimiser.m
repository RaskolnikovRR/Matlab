...
[intmats,intmatC1,intmatC2,intmatC3] = convexopt(cvar,xdel,ydel,sdel,hdel,xi,yi,si,hi,Pxy);
...
[x fval] = fmincon(@(Q) costfun(Q,dels,mins,maxs),x0,[],[],Aeq,beq,lb,[],@(Q) nonlcon(cvar,Ps,Pxy,Q,dels,ni,intmats) ,options);
